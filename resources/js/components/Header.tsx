            ...
            <div className="container mx-auto px-4">
                ...
                <nav className="w-full overflow-x-auto custom-scrollbar pb-2">
                    <ul className="flex justify-start sm:justify-center lg:justify-between gap-x-4 sm:gap-x-6 text-gray-700 font-medium text-sm">
                        ...
                        {categories.map((e) => {
                            <li><Link href={'/category/' + e.slug} className="hover:text-blue-600 whitespace-nowrap px-3 py-2 rounded-md transition-colors duration-200 block bg-gray-50 hover:bg-gray-100">{e.name}</Link></li>
                        })}
