// resources/js/Pages/StorePage.jsx (or similar path if it's a page component)
...
const StorePage = ({ storeName:string }) => { // storeName will be passed as a prop from Laravel
    ...
    <div className="bg-gray-100 pb-8 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="text-sm text-gray-600 mb-6">
          ...
          {/* IMPORTANT: Use href instead of to, and ensure route exists in Laravel */}
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-8 mb-8 p-4 bg-white rounded-lg shadow-md">
          ...
          <div>
            ...
            <p className="text-base sm:text-xl text-gray-600 mt-2 text-center sm:text-left">One Line On Store (e.g., Official Coupons & Deals)</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-1 p-4 lg:pl-8 space-y-8 mt-8 lg:mt-0">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <ul className="list-disc list-inside space-y-2 text-blue-600">
                {/* Replace # with actual Inertia Link hrefs if these are internal */}
