        ...
        <header className="shadow-md py-3 relative font-sans" style={{ backgroundColor: 'var(--header-bg)', borderBottom: '1px solid var(--border-light)' }}>
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
                ...
                <div className="flex flex-wrap items-center justify-between gap-y-4 md:flex-nowrap pb-4 border-b border-gray-200 mb-4">
                    ...
                    {/* Categories Button for Mobile - this is the TRIGGER for the mobile dropdown */}
                    <div
                        className="md:hidden order-2 relative" // This div's 'relative' is for the button's internal layout, not the dropdown
                        ref={mobileCategoriesButtonRef}
                    >
                        <button
                            onClick={toggleMobileMenu}
                            className="mobile-menu-toggle px-4 py-2 border rounded-md text-sm font-medium flex items-center focus:outline-none focus:ring-2 focus:ring-blue-500"
                            style={{ borderColor: 'var(--search-input-border)', color: 'var(--search-input-text)' }}
                        >
                            Categories <ChevronDownIcon className="ml-1 h-4 w-4" />
                        </button>
                    </div>

                    {/* Right Section: Blog, Summer Sales, Exclusive Vouchers (Desktop) */}
                    <div className="hidden md:flex items-center gap-x-3 flex-shrink-0 md:order-3 ml-auto">
                        ...
                        <Link href="/summer-sales" className="font-bold text-sm whitespace-nowrap transition-colors duration-300" style={{ color: 'var(--text-default)' }}
                            onMouseEnter={(e) => e.currentTarget.style.color = 'var(--text-accent-hover)'}
                            onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-default)'}
                        >
                            <span className="inline-block align-middle mr-1" role="img" aria-label="summer-sales-icon">☀️</span>Summer Sales
                        </Link>
                        <Link href="/exclusive-vouchers" className="font-bold text-sm whitespace-nowrap transition-colors duration-300" style={{ color: 'var(--text-default)' }}
                            onMouseEnter={(e) => e.currentTarget.style.color = 'var(--text-accent-hover)'}
                            onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-default)'}
                        >
                ...
                {/* Categories Section (Desktop only - hidden on mobile) */}
                <div className="relative pt-4 pb-2 text-center mt-4 hidden md:block">
